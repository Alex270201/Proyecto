...
// Proyecto.cpp: define los comportamientos de las clases para la aplicación.
//
...
// Único objeto CProyectoApp

CProyectoApp theApp;


// Inicialización de CProyectoApp
